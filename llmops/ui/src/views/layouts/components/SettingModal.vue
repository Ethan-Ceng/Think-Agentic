        ...
        <el-form :model="{}" label-position="top">
          ...
          <el-form-item prop="name">
            ...
            <div v-else class="flex items-center gap-1">
              ...
              <el-button size="mini" type="text" class="text-gray-700!" @click="updateName = true">
                <template #icon>
                  <icon-edit />
                </template>
              </el-button>
          ...
          <el-form-item prop="password">
            ...
            <div v-if="updatePassword" class="flex items-center gap-2 w-full">
              <!-- 左侧输入框 -->
              <el-input v-model="accountForm.password" placeholder="请输入账号密码" />
              <!-- 取消&保存 -->
              <div class="flex items-center gap-1">
                <el-button
                  class="rounded-lg"
          ...
          <el-form-item prop="email" label="绑定邮箱">
            <el-input readonly v-model="accountForm.email" />
          </el-form-item>
        </el-form>
      </div>
    </div>
