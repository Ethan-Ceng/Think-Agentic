...
<template>
  <div
    class="flex flex-col gap-3 rounded-2xl p-3 bg-white border-2 border-transparent shadow-xs hover:shadow-md selected-border transition-all w-[360px]"
  >
    <!-- 节点标题信息 -->
    <div class="flex items-center gap-2">
      <el-avatar shape="square" :size="24" class="bg-violet-500 rounded-lg shrink-0">
    ...
    <div class="flex flex-col items-start bg-gray-100 rounded-lg p-3">
      ...
      <div class="w-full flex items-center mb-2 text-gray-700 text-xs gap-2">
        <!-- 左侧变量名 -->
        <div class="w-[180px] shrink-0 flex items-center gap-2 text-gray-700">
          <icon-caret-down />
      ...
      <div class="w-full flex flex-col gap-2">
        ...
        >
          ...
          <div class="w-[180px] shrink-0 flex items-center gap-2">
            ...
            <div class="text-gray-500 bg-gray-200 px-1 py-0.5 rounded-sm shrink-0">
              {{ input.type }}
            </div>
          </div>
          <!-- 右侧变量引用 -->
          <div class="flex-1 flex">
            <div
              ...
              class="bg-white line-clamp-1 break-all text-gray-500 border px-1 py-0.5 rounded-sm"
            >
    ...
    <div class="flex flex-col items-start bg-gray-100 rounded-lg p-3">
      ...
      <div class="flex flex-col gap-2">
        ...
        >
          <!-- 左侧知识库图标 -->
          <el-avatar :size="16" shape="square" :src="dataset?.icon" />
          <!-- 右侧知识库名称 -->
