...
<template>
  <div
    class="flex flex-col gap-3 rounded-2xl p-3 bg-white border-2 border-transparent shadow-xs hover:shadow-md selected-border w-[360px]"
  >
    <!-- 节点标题信息 -->
    <div class="flex items-center gap-2">
      <el-avatar shape="square" :size="24" class="bg-emerald-400 rounded-lg shrink-0">
        <icon-branch :size="16" />
      </el-avatar>
