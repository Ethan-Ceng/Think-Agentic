...
<template>
  ...
  >
    ...
    <div class="flex items-center gap-2">
      <el-avatar shape="square" :size="24" class="bg-rose-500 rounded-lg shrink-0">
        <icon-link :size="16" />
      </el-avatar>
      ...
      <div class="w-full flex flex-col gap-2">
        ...
        >
          ...
          <div class="w-[180px] shrink-0 flex items-center gap-2">
            ...
            <div
              class="max-w-[60px] line-clamp-1 break-all text-gray-500 bg-gray-200 px-1 py-0.5 rounded-sm shrink-0"
            >
              {{ input.type }}
            </div>
          </div>
