...
<template>
  <div
    class="flex flex-col gap-3 rounded-3xl p-3 bg-white border-2 border-transparent shadow-xs hover:shadow-md selected-border w-[240px]"
  >
    <!-- 顶部节点标题 -->
    <div class="flex items-center gap-2">
      <el-avatar shape="square" :size="24" class="bg-blue-700 rounded-lg shrink-0">
        <icon-home :size="16" />
      </el-avatar>
