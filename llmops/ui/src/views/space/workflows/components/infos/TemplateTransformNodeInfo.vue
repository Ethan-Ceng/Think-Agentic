...
<template>
  <div
    v-if="props.visible"
    id="template-transform-node-info"
  ...
  >
    ...
    <div class="flex items-center justify-between gap-3 mb-2">
      ...
      <div class="flex items-center gap-1 flex-1">
        <el-avatar :size="30" shape="square" class="bg-emerald-400 rounded-lg shrink-0">
          <icon-branch />
        </el-avatar>
        <el-input
          v-model="form.title"
    ...
    >
      ...
      <div class="flex flex-col gap-2">
        ...
        <el-form-item prop="template" required>
          <el-input
...
<style>
#template-transform-node-info :deep(.el-select-dropdown__item) {
