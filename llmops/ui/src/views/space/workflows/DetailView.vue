...
onConnect((connection) => {
  ...
  if (isAlreadyConnected) {
    ElMessage.error('这两个节点已有连接，无需重复添加')
    return
  }
    ...
    >
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="flex items-center gap-3">
          <!-- 工作流图标 -->
          <el-avatar :size="40" shape="square" class="rounded-lg" :src="workflow.icon" />
          <!-- 工作流信息 -->
          <div class="flex flex-col justify-between h-[40px]">
            <el-skeleton-item v-if="getWorkflowLoading" :widths="[100]" />
        ...
        <panel position="bottom-center">
          <div class="p-[5px] bg-white rounded-xl border z-50">
            <el-space :size="8">
              ...
              <!-- 添加节点 -->
              <el-popover placement="top" :popup-translate="[0, -16]">
                <el-button type="primary" size="small" class="rounded-lg px-2">
                  <template #icon>
                ...
                <template #content>
                  <div
                    class="bg-white borer border-gray-200 w-[240px] shadow-sm rounded-xl overflow-hidden py-2"
                  >
                    <!-- 开始节点 -->
                    <div
                    ...
                    >
                      <!-- 节点名称 -->
                      <div class="flex items-center gap-2">
                        <el-avatar shape="square" :size="24" class="bg-blue-700 rounded-lg">
                          <icon-home />
                        </el-avatar>
                    ...
                    >
                      <!-- 节点名称 -->
                      <div class="flex items-center gap-2">
                        <el-avatar shape="square" :size="24" class="bg-sky-500 rounded-lg">
                          <icon-language />
                        </el-avatar>
                    ...
                    >
                      <!-- 节点名称 -->
                      <div class="flex items-center gap-2">
                        <el-avatar shape="square" :size="24" class="bg-orange-500 rounded-lg">
                          <icon-tool />
                        </el-avatar>
                    ...
                    >
                      <!-- 节点名称 -->
                      <div class="flex items-center gap-2">
                        <el-avatar shape="square" :size="24" class="bg-violet-500 rounded-lg">
                          <icon-storage />
                        </el-avatar>
                    ...
                    >
                      <!-- 节点名称 -->
                      <div class="flex items-center gap-2">
                        <el-avatar shape="square" :size="24" class="bg-emerald-400 rounded-lg">
                          <icon-branch />
                        </el-avatar>
                    ...
                    >
                      <!-- 节点名称 -->
                      <div class="flex items-center gap-2">
                        <el-avatar shape="square" :size="24" class="bg-rose-500 rounded-lg">
                          <icon-link />
                        </el-avatar>
                    ...
                    >
                      <!-- 节点名称 -->
                      <div class="flex items-center gap-2">
                        <el-avatar shape="square" :size="24" class="bg-cyan-500 rounded-lg">
                          <icon-code />
                        </el-avatar>
                    ...
                    >
                      <!-- 节点名称 -->
                      <div class="flex items-center gap-2">
                        <el-avatar shape="square" :size="24" class="bg-red-700 rounded-lg">
                          <icon-filter />
                        </el-avatar>
              ...
              <div class="flex items-center gap-3">
                ...
                <el-dropdown
                  ...
                  "
                >
                  <el-button size="small" class="text-gray-700! px-2 rounded-lg gap-1 w-[80px]">
                    {{ (zoomLevel * 100).toFixed(0) }}%
                    <icon-down />
                  </el-button>
                  <template #dropdown><el-dropdown-menu>
                    <el-dropdown-item v-for="zoom in zoomOptions" :key="zoom.value" :value="zoom.value">
                      {{ zoom.label }}
                    </el-dropdown-item>
                  </el-dropdown-menu></template></el-dropdown>
              </div>
