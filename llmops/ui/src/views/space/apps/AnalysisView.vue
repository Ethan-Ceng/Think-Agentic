...
<template>
  <div class="px-6 py-5 overflow-scroll scrollbar-y-sleek">
    <!-- 概览指标 -->
    <div class="flex flex-col gap-5 mb-5">
      ...
      <!-- 指标卡片 -->
      <div v-loading="getAppAnalysisLoading">
      ...
      <div v-loading="getAppAnalysisLoading">
        <div class="grid grid-cols-2 gap-4">
          <div class="flex flex-col bg-white rounded-lg border border-gray-200 p-4 h-[300px]">
            ...
            <!-- 副标题 -->
            <div class="text-gray-500 mb-1 shrink-0">过去7天</div>
            <!-- 可视化图表 -->
          ...
          <div class="flex flex-col bg-white rounded-lg border border-gray-200 p-4 h-[300px]">
            ...
            <div class="flex items-center gap-2 mb-1 shrink-0">
              ...
              <el-tooltip content="反映每日该应用请求语言模型的 Tokens 花费，用于成本控制。">
                <icon-question-circle-fill />
              </el-tooltip>
            </div>
            <!-- 副标题 -->
