...
const handleFileChange = async (event: Event) => {
  ...
  if (selectedFile) {
    try {
      ...
      image_urls.value.push(resolveApiAssetUrl(resp.data.image_url))
  ...
  <div class="">
    ...
    <div v-if="messages.length > 0"
      ...
      <div v-if="task_id && debugChatLoading" class="h-[50px] flex items-center justify-center">
        <el-button :loading="stopDebugChatLoading" class="rounded-lg px-2" @click="handleStop">
          <template #icon>
            <icon-poweroff />
          </template>
          停止响应
    ...
    >
      ...
      <div class="flex flex-col items-center gap-2">
        <el-avatar
          ...
          shape="square"
          class="rounded-lg"
          :src="resolveApiAssetUrl(String(props.app?.icon ?? ''))"
        />
        ...
        >
          ...
          <div v-if="image_urls.length > 0" class="flex items-center gap-2">
            <div
              ...
              <el-avatar shape="square" :src="resolveApiAssetUrl(String(image_url))" />
              <div
          ...
          <div class="flex items-center gap-2">
            ...
            <template v-if="audioToTextLoading">
              <el-button size="small" link shape="circle">
                <template #icon>
                  <icon-loading />
                </template>
              </el-button>
            ...
            <template v-else>
              ...
              <!-- 结束音频录制按钮 -->
              <el-button v-else size="small" link shape="circle" @click="handleStopRecord">
                <template #icon>
                  <icon-pause />
                </template>
              </el-button>
