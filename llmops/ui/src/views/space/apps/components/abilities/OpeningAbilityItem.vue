...
const setOpeningQuestionAt = (idx: number, value: string) => {
  const next = [...computed_opening_questions.value]
  next[idx] = value
  computed_opening_questions.value = next
}
</script>

<template>
  <div class="">
    <el-collapse-item name="opening" class="app-ability-item">
      <template #title>
        <div class="flex w-full items-center pr-2">
          <span class="text-sm font-bold leading-none text-gray-700">对话开场白</span>
        </div>
      </template>
      ...
      <div class="text-xs text-gray-500">
        ...
        <div class="flex flex-col gap-2 mb-2">
          <div class="flex items-center gap-2">
            ...
            <el-tooltip content="开场白是与Agent应用对话时，Agent默认展示的对话。">
        ...
        <div class="flex flex-col gap-2 mb-2">
          <div class="flex items-center gap-2">
            ...
            <el-tooltip content="开场白预设问题是与Agent对话时，初始化提供的建议问题，最多不超过3个">
              <icon-exclamation-circle />
            </el-tooltip>
          </div>
          <!-- 预设问题列表 -->
          <div class="flex flex-col gap-2">
            ...
            >
              <el-input
                ...
                @update:model-value="(value: string) => setOpeningQuestionAt(idx, value)"
