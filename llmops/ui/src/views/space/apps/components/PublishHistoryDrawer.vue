    ...
    >
      ...
      <div class="">
        ...
        <div class="flex items-center gap-3 mb-3">
          <!-- 左侧图标 -->
          <el-avatar :size="40" shape="square" class="rounded-lg" :src="app?.icon" />
          <!-- 右侧信息 -->
      ...
      <el-card
        ...
        shadow="hover"
        class="rounded-lg mb-4 cursor-pointer transition-shadow group"
      >
        <div class="flex items-center justify-between">
          ...
          <div class="flex flex-col gap-2">
            <div class="flex items-center gap-2">
              ...
              <el-tag size="small" class="text-gray-700 rounded-lg border! border-gray-100!">
      ...
      <div v-if="paginator.total_page >= 2" class="flex items-center justify-center">
        <!-- 数据加载中 -->
        <el-space v-if="paginator.current_page <= paginator.total_page" class="my-4">
          <div />
