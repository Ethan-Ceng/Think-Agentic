...
<template>
  ...
  >
    ...
    <div class="w-[600px] h-full min-h-screen mx-auto">
      ...
      <div
        v-else
        :class="`flex flex-col p-6 gap-2 items-center justify-center overflow-scroll scrollbar-y-sleek ${image_urls.length > 0 ? 'h-[calc(100%-150px)] min-h-[calc(100vh-150px)]' : 'h-[calc(100%-100px)] min-h-[calc(100vh-100px)]'}`"
      >
        <div class="mb-9">
        ...
        <div class="flex gap-2">
          <!-- 左侧图标 -->
          <el-avatar :size="30" shape="circle" class="shrink-0 bg-blue-700">
            <icon-apps />
          </el-avatar>
          <!-- 右侧名称与消息 -->
