                                ...
                                <div class="flex flex-1 items-center min-w-0 pr-4">
                                    ...
                                    >
                                        ...
                                        <template #dropdown>
                                            <el-dropdown-menu>
                                                <popover-input
                                                    v-perms="['common:file:cateRename']"
            ...
            <div class="material-center__content flex flex-col flex-1 mb-1 min-h-0">
                    ...
                    <ul class="file-list flex flex-wrap mt-4">
                        ...
                        >
                            ...
                            <div class="operation-btns flex items-center">
                                <popover-input
                                    v-perms="['common:file:fileRename']"
                                ...
                                <el-button type="primary" link @click="handlePreview(item.url || item.uri)">
                                    查看
                                </el-button>
                            </div>
                        </li>
                ...
                >
                    ...
                    <el-table-column label="图片" width="100">
                        <template #default="{ row }">
                            <file-item :uri="row.url || row.uri" file-size="50px" :type="type"></file-item>
                        </template>
                    </el-table-column>
                    <el-table-column label="名称" min-width="100" show-overflow-tooltip>
                        <template #default="{ row }">
                            <el-link @click.stop="handlePreview(row.url || row.uri)" underline="never">
                                {{ row.name }}
                            </el-link>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="操作" width="150" fixed="right">
                        <template #default="{ row }">
                            <div class="inline-block" v-perms="['common:file:fileRename']">
                                <popover-input
                            ...
                            <div class="inline-block">
                                <el-button type="primary" link @click.stop="handlePreview(row.url || row.uri)">
                                    查看
                                </el-button>
                            </div>
                            <div class="inline-block" v-perms="['common:file:fileDel']">
                                <el-button
                                    type="primary"
                                    link
